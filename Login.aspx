...
<style type="text/css">
        body { background-image:url('images/bkgs/1.jpg'); background-repeat:no-repeat; }
</style>
...
<body>
    <form id="Form1" runat="server">
        ...
        <div id="announcementPanel" runat="server">
            <a href="PreRegistration.aspx"><img id="imageAnnouncement" style="width:487px; height:268px;" src="Images/msgs/grand_opening.png" border="0" /></a>
        </div>
        <asp:ScriptManager ID="ScriptManager1" runat="server"/>  
        <asp:Accordion ID="loginAccordion" runat="server" AutoSize="None" FadeTransitions="true" 
            TransitionDuration="250" FramesPerSecond="40" SelectedIndex="0" 
            ContentCssClass="accordionContent" HeaderCssClass="accordionHeader">
            <Panes>
                <asp:AccordionPane ID="LoginPane" runat="server">
                    <Header>
                        <a href="" onclick="return false;">PeaShake House Login</a>
                    </Header>
                    <Content>
                        ...
                        <asp:Login ID="LoginUser" DestinationPageUrl="Members/Members.aspx" runat="server" EnableViewState="false" RenderOuterTable="false">
                            <LayoutTemplate>
                                <div class="accountInfo">
                                    <table width="80%">
                                        <tr>
                                            <td align="left" width="25%">
                                                <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" CssClass="regLabel">Name/Email:</asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="UserName" runat="server" CssClass="textEntryLogin" TabIndex="1" />
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="Password" runat="server" CssClass="textEntryLogin" TextMode="Password" TabIndex="2" />
                                    ...
                                    <table width="80%">
                                        <tr>
                                            <td align="left">
                                                <asp:CheckBox ID="AgreeRules" CssClass="green" runat="server" Text="I agree to abide by<br />the Peashake House <a href='#' onclick='showDisclaimer()' tabindex='4'>rules</a>" TabIndex="3"/>
                                                <skm:CheckBoxValidator runat="server" id="AgreeRulesValidator" ControlToValidate="AgreeRules" 
                                                    Display="Dynamic" ErrorMessage='You must agree to the terms of service before you can continue.' 
                                                    validationgroup="LoginUserValidationGroup" AssociatedButtonControlId="LoginButton" 
                                                    MustBeChecked="True">*</skm:CheckBoxValidator>
                                            </td>
                                            <td align="center">
                                                <asp:ImageButton ID="LoginButton" runat="server" CommandName="Login" ImageUrl="~/Images/Buttons/Login.gif" 
                                                    ValidationGroup="LoginUserValidationGroup" TabIndex="5" style="vertical-align:middle;" />
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="3" align="right">
                                                <span class="green">
                                                    Not a member yet?<a href="#" onclick="$find('loginAccordion_AccordionExtender').set_SelectedIndex(1);" tabindex="6">
                                                    Sign up here.</a>
                                                </span>
                                            </td>
                                        </tr>
                ...
                <asp:AccordionPane ID="RegistrationPane" runat="server">
                    <Header>
                        <a href="" onclick="return false;">PeaShake House Registration / Sign-Up</a>
                    </Header>
                    <Content>
                        <div class="blackpaper">
                        <center>
                                ...
                                <asp:WizardStep ID="RegisterUserWizardStep0" runat="server">
                                    ...
                                    <center>
                                        ...
                                        <p>
                                            ...
                                            Already registered? <a href="#" onclick="$find('loginAccordion_AccordionExtender').set_SelectedIndex(0);">Login here.</a>
                                        </p>
                                    </center>
                                    </span>
                                </asp:WizardStep>
                ...
                <asp:AccordionPane ID="JoinPane" runat="server">
                    <Header>
                        <a href="" onclick="return false;">Subscription Options</a>
                    </Header>
                    <Content>
                        <div class="blackpaper">
                            <span class="green">
                                ...
                                <p>
                                    <asp:RadioButtonList CssClass="green" id="subscriptionOptions" runat="server">
                                        <asp:ListItem selected="true">90-Day Plan $29.99</asp:ListItem>
                                        <asp:ListItem>30-Day Plan $19.99</asp:ListItem>
                                        <asp:ListItem>24HrPass $1.99</asp:ListItem>
                                    </asp:RadioButtonList>
                                </p>
                                <p>
                                    <asp:ImageButton ID="JoinButton" runat="server" ImageUrl="~/Images/Buttons/Join.gif"  />
                                </p>
                                </center>
                            </span>
                        </div>
